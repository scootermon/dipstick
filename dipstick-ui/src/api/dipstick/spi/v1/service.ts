...
/**
 * @generated from protobuf message dipstick.spi.v1.TransactionsRequest
 */
...
/**
 * @generated from protobuf message dipstick.spi.v1.TransactionsResponse
 */
...
// @generated message type with reflection information, may provide speed optimized methods
class TransactionsRequest$Type extends MessageType<TransactionsRequest> {
  constructor() {
    super("dipstick.spi.v1.TransactionsRequest", [
      { no: 1, name: "selector", kind: "message", T: () => EntitySelector },
    ]);
  }
  create(value?: PartialMessage<TransactionsRequest>): TransactionsRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined)
      reflectionMergePartial<TransactionsRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
/**
 * @generated MessageType for protobuf message dipstick.spi.v1.TransactionsRequest
 */
export const TransactionsRequest = new TransactionsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TransactionsResponse$Type extends MessageType<TransactionsResponse> {
  constructor() {
    super("dipstick.spi.v1.TransactionsResponse", [
      { no: 1, name: "timestamp", kind: "message", T: () => Timestamp },
      { no: 2, name: "rx", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
      { no: 3, name: "tx", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
    ]);
  }
  create(value?: PartialMessage<TransactionsResponse>): TransactionsResponse {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.rx = new Uint8Array(0);
    message.tx = new Uint8Array(0);
    if (value !== undefined)
      reflectionMergePartial<TransactionsResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
/**
 * @generated MessageType for protobuf message dipstick.spi.v1.TransactionsResponse
 */
export const TransactionsResponse = new TransactionsResponse$Type();
/**
